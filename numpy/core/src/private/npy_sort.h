...
int npy_quicksort(char *start, npy_intp num, PyArrayObject *arr);
int npy_heapsort(char *start, npy_intp num, PyArrayObject *arr);
int npy_mergesort(char *start, npy_intp num, PyArrayObject *arr);
